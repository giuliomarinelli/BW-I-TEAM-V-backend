...
//        Tratta tratta1 = trattaDao.findOne(1);
//
//        Tram tram1 = new Tram();
...
//
//
//        Tessera tessera1 = tesseraDao.getbyid(1);
//        Tessera tessera2 = tesseraDao.getbyid(2);
//
...
//        int count = titoloDiViaggioDAO.numeroAbbonamentiTotaliEmessi(LocalDateTime.of(LocalDate.of(2024, 1, 15), LocalTime.of(0, 0,0)),
//                LocalDateTime.of(LocalDate.of(2024, 1, 30), LocalTime.of(0, 0,0)));
//
//        System.out.println(count);

//        TitoloDiViaggio t = new Biglietto();
//        t.setDataEmissione(LocalDateTime.of(LocalDate.of(2024, 1, 1), LocalTime.of(0, 0, 0)));
//        t.setEmittente(emittenteDao.getById(1));
//        titoloDiViaggioDAO.emettiTitolo(t);
